...
class SimplePromptBot {
    ...
    async askForName(dc, step) {
        return await dc.prompt(NAME_PROMPT, `What is your name, Kemal ?`);
    }
            ...
            if (turnContext.activity.membersAdded.length !== 0) {
                ...
                for (var idx in turnContext.activity.membersAdded) {
                    ...
                    if (turnContext.activity.membersAdded[idx].id !== turnContext.activity.recipient.id) {
                        ...
                        await turnContext.sendActivity('I am a Kemal bot that demonstrates the TextPrompt class to collect your name, store it in UserState, and display it. Say anything to continue.');
                    }
                }
            }
        }
